/****** Object:  Table [cons_customer].[customer_profile_dev]    Script Date: 3/22/2022 6:43:32 AM ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [cons_customer].[customer_profile]
(
	...
	[average_units_sold_per_transaction] [int] NULL,
	[lifetime_return_quantity] [int] NULL,
	[total_lifetime_value_aud] [float] NULL,
	[average_transaction_value_aud] [float] NULL,
	--[customer_journey_state] [varchar](250) NULL, /* Removed as per discussion with Emma */
